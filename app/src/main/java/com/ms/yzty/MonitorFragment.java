...
public class MonitorFragment extends Fragment {
    ...
    private TextView textViewCap1MotionNum;
    private TextView textViewCap2MotionNum;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        textViewCap1MotionNum =view.findViewById(R.id.textView_cap1_motion_num);
        textViewCap2MotionNum =view.findViewById(R.id.textView_cap2_motion_num);
        return view;
    }
        ...
        if(buf[21] < 0)
            ...
            b = buf[21];
        s = (long)( b + a*256)+ "";
        textViewCap1MotionNum.setText(s);
        ...
        if(buf[23] < 0)
            ...
            b = buf[23];
        s = (long)( b + a*256)+ "";
        textViewCap2MotionNum.setText(s);
    }
}
